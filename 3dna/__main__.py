...
def main():
    ...
    if args.optimize:
        ...
        optimizer = GeneticOptimizer(population_size=args.population, generations=args.generations, mutation_rate=args.mutation_rate)
        ...
        optimizer1 = SimulatedAnnealingOptimizer(population_size=args.population, generations=args.generations, mutation_rate=args.mutation_rate)
...
if __name__ == "__main__" :
    #python3 -m 3dna data/plasmid_8k.fasta --optimize --generations 200 --population 100 --mutation_rate 0.2
    main()
